<template>
  <nav class="header__nav" :class="toggleMenuStatus()" aria-label="Navigation principal">
    <button
      class="menu-toggle"
    ...
    <ul class="menu">
      ...
      <li class="menu__item">
        <g-link class="menu__link" to="/actualites/">Actualités</g-link>
      </li>
      <li class="menu__item">
...
.menu__link.is-accent:hover,
.menu__link.is-accent.active {
